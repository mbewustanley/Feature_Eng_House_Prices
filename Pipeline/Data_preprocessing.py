...
def load_data():
    # Read data
    df_train = pd.read_csv("Input_data/train.csv", index_col="Id")
    df_test = pd.read_csv("Input_data/test.csv", index_col="Id")
...
def main():
    try:
        ...
        print(f"Error: {e}")
        print("Failed to complete the data preprocessing.")
